        ...
        <el-tab-pane label="列表" name="list" style="width:100%;height:100%;">
          ...
          >
            <div class="operCycle">
              ...
              >
                <div style="display:flex;flex:1.2;margin-left:20px;">
                  对比区域：
                </div>
                <div
                  style="display:flex;justify-content:flex-start;flex-wrap:wrap;flex:18;"
                ...
                >
                  <div style="display:flex;justify-content:flex-start;flex:15;">
                    ...
                    >
                      <el-checkbox
                        v-for="(item,
                        index) in dictionary.administrative_regions"
                        :label="item.id"
          ...
          >
            ...
            <el-table-column label="交易类型" min-width="120">
              ...
              <span v-if="filterData.landTrans != ''">{{
                filterData.landTrans
              }}</span>
            </el-table-column>
            ...
            <el-table-column label="时间" min-width="400">
              ...
              <span v-if="submitTime != ''"
                >{{ submitTime[0] }}-{{ submitTime[1] }}</span
              >
            </el-table-column>
  ...
  methods: {
    ...
    getList() {
      if (this.filterData.cantonProvince == "") {
        ...
        // this.$get(`/epf-monitor/statistics/trans/queryGroupByTimeOfCantonList`, params).then(res => {
        this.$get(
