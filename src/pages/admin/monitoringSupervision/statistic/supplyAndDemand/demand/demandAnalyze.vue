            ...
            >
              ...
              >
                ...
                <span class="button_export"
                  ><a :href="hrefUse" style="color: #ffa000;">导出</a></span
                >
              </div>
              <div
                id="daUseChart"
              ...
              >
                ...
                <el-table-column label="需求类型" min-width="120">
                  <template slot-scope="scope">
                    ...
                    <span v-if="scope.row.demandName != 'null'">{{
          ...
          >
              ...
              >
                <div class="operCycle">
                  <div style="display:flex;">
                    ...
                    <span class="button_export"
                      ><a :href="hrefCycle" style="color: #ffa000;"
                        >导出</a
                      ></span
                    >
                  </div>
            ...
            >
              <div class="toolsTitleBox">
                <span class="toolsTitle">数据列表</span>
                <span class="button_export"
                  ><a :href="hrefCycle" style="color: #ffa000;">导出</a></span
                >
              </div>
              <el-table
                ref="multipleTable"
          ...
          >
            ...
            >
              ...
              >
                <span></span>
                <span class="button_export"
                  ><a :href="hrefArea" style="color: #ffa000;">导出</a></span
                >
              </div>
              <div
                id="daAreaChart"
...
<script>
import demandAnalyzeSearch from "@/components/demandAnalyzeSearch";
