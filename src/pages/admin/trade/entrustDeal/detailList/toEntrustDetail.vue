                  ...
                  <ul class="publish_mainUl">
                    ...
                    <li>
                      <div style="display: flex;">
                          ...
                          <el-select v-model="ruleForm.cantonProvinceName" disabled  @change="provinceSelect(dictionary.administrative_regions,ruleForm.cantonProvinceName,$event)" >
                          ...
                          <el-form-item prop="cantonCity" class="canton_Regions" label-width="5px">
                              <el-select v-model="ruleForm.cantonCityName" disabled  @change="citySelect(dictionary.cantonCity,ruleForm.cantonCityName,$event)">
                          ...
                          <el-form-item prop="cantonArea" class="canton_Regions" label-width="5px">
                              <el-select v-model="ruleForm.cantonAreaName" disabled  @change="areaSelect(dictionary.cantonAreaName,ruleForm.cantonAreaName,$event)">
                    ...
                    <li>
                      <el-form-item label="使用权截止日期：" prop="years" label-width="136px">
                        <el-col :span="16">
                    ...
                    <li>
                      <el-form-item :label="publishLandtype+'年限：'" prop="years"  style="width:100%;">
                          <el-input v-model="ruleForm.years" disabled  :placeholder="'请输入'+publishLandtype+'年限'"  style="width:360px;"></el-input>
                    ...
                    <li>
                      <el-form-item label="南至：">
                        <el-input v-model="ruleForm.south" disabled placeholder="南至***路" style="width:360px;"></el-input>
                      </el-form-item>
                    </li>
                    <li>
                      <el-form-item label="西至：">
                          <el-input v-model="ruleForm.west" disabled placeholder="西至***路" style="width:360px;"></el-input>
                      </el-form-item>
                    </li>
                    <li>
                    ...
                    <li>
                      <el-form-item :label="'拟'+ruleForm.circulationName+'价格：'">
                        <el-input :value="ruleForm.price?Division(ruleForm.price):0" disabled :placeholder="'拟'+ruleForm.circulationName+'价格,例如：1000.20，不填则显示面议'" style="width:360px;"></el-input>
                    ...
                    <li>
                      <el-form-item label="是否连同地上建筑物、其他附着物：" required  label-width="300px">
                    ...
                    <li v-show="ruleForm.isAdjunct=='0'">
                      <el-form-item label="建筑结构：">
                          <el-input v-model="ruleForm.buildingStructureName" disabled  placeholder="例如：3000.11" style="width:340px;"></el-input>
                      </el-form-item>
                    </li>
                    <!-- <li v-show="ruleForm.isAdjunct=='0'">
                      ...
                      <el-form-item v-show="ruleForm.useType == 'tosell'" label="建设用地使用权出让合同号：" prop="decisionNum">
                          <el-input v-model="ruleForm.decisionNum" disabled  placeholder="请输入建设用地使用权出让合同号" style="width:360px;"></el-input>
                      </el-form-item>
                    </li> -->
                    ...
                    <li style="width:100%; display: flex;flex-direction: row;">
                  ...
                  <ul class="publish_mainUl">
                    <li>
                      <el-form-item label="权属人性质：" prop="ownerShipNature" label-width="175px">
                        <el-select v-model="ruleForm.ownerShipNatureName" placeholder="请选择" disabled >
                            <el-option v-for="item in dictionary.tans_owner_type" :ref="item.zhCn" :dictKey="item.dictKey" :id="item.id" :label="item.zhCn" :value="item.zhCn" :key="item.id"></el-option>
                        </el-select>
                      </el-form-item>
                    </li>
                    <li>
                    ...
                    <li>
                      <el-form-item label="证件种类：" prop="identificationType" label-width="175px">
                        <el-select v-model="ruleForm.identificationTypeName" placeholder="请选择" disabled>
                          <el-option v-for="item in dictionary.certifiate_type" :ref="item.zhCn" :dictKey="item.dictKey" :id="item.id" :label="item.zhCn" :value="item.zhCn" :key="item.id"></el-option>
                        </el-select>
                      </el-form-item>
                    </li>
                    <li>
        ...
        <div class="bondBox" v-if="paymentData != null">
              ...
              <el-row style="margin-top:20px;">
                ...
                <el-col :span="10" style="text-align: right;">
                  ...
                  <el-input style="width:300px;" :value="paymentData.amount?(paymentData.amount<5?5:paymentData.amount):0"></el-input>
    ...
    return {
      ...
      isdecisionNumFile:true,
       ...
       rules: {
        ...
        dicRequest:['flow_mode','land_nature','use_type','land_type','land_use','own_no_type','register_organization','building_structure','tans_owner_type','certifiate_type'],//字典码请求
        dictionary:{//字典码结果
            flow_mode:"",
            land_nature:"",
            use_type:"",
  ...
  methods: {
    ...
    init(){
      ...
      if(this.$route.query.id){//委托交易列表携带Id进入
        this.$get('/epf-trade/admin/transgoods/getTransGoods',{id:this.$route.query.tgId}).then(res=>{
    ...
    createChildAccount(){
      //改变状态
      this.$post('/epf-trade/admin/transtrustinfo/createChildNo',{id:this.$route.query.id}).then(res => {
        if(res.msg != '0'){
          //失败
          this.$message.error(res.msg);
          return
    ...
    getSeeBond(parameter){ //查看履约保证金
      ...
      this.$get('/epf-trade/admin/transgoodsearnestmoney/getEarnestMoneyInfo',parameter).then(res=>{
        if (res.code == "0") {
    ...
    paymentRecord(){ //查看缴纳记录
      ...
      this.$get('/epf-trade/admin/transaccountbill/getBillBYApplyId',this.pay).then(res=>{
    ...
    firstClassUseSelect(dic,firstClassUse,event){
        ...
        this.$get(`/epf-supply/admin/dictionaries/getDictsByCodeOrParentId?code=land_use&parentId=${pId}`,{}).then(res => {
