        ...
        <div class="publish_main">
          ...
          >
            <div class="firststep" v-if="active === 0" align-center>
              <EPF-switchTitle titles_h="土地基本信息">
                <div class="publish_main_cont">
                  <ul class="publish_mainUl">
                      ...
                      <div style="display: flex;flex-direction: row;">
                        ...
                        >
                          ...
                          >
                            <el-option
                              v-for="(item,
                              index) in dictionary.land_use_second"
                              :ref="item.zhCn"
                              :label="item.zhCn"
                              :dictKey="item.dictKey"
                              :value="item.zhCn"
                    ...
                    <li>
                      <el-form-item
                        :label="'拟' + ruleForm.circulationName + '价格：'"
                        prop="price"
                      >
                        <el-input
                    ...
                    <li>
                      <el-form-item
                        ...
                        prop="isAdjunct"
                      >
                        <el-radio v-model="ruleForm.isAdjunct" label="0"
                          >是</el-radio
                        >
                        <el-radio v-model="ruleForm.isAdjunct" label="1"
                          >否</el-radio
                        >
                      </el-form-item>
                    </li>
                    ...
                    <li v-show="ruleForm.isAdjunct == '0'">
                      <el-form-item label="建筑结构：" prop="buildType">
                        <el-select
                          ...
                          @change="
                            buildingTypeSelect(
                              dictionary.building_structure,
                              ruleForm.buildingStructureName,
                              $event
                            )
                          "
                        >
                    ...
                    >
                      ...
                      >
                        <el-input
                          v-model.number="ruleForm.buildingDensity"
                          placeholder="建筑密度下限"
                          style="width:140px;"
                        ></el-input>
                      </el-form-item>
                      <el-form-item class="canton_Regions">
                        ...
                        >
                          <el-option
                            v-for="(item,
                            index) in buildingDensitySymbolSelect1"
                            :key="index"
                            :label="item.label"
                            :value="item.value"
                          ></el-option>
                      ...
                      <span
                        style="margin:0 17px;color:#606266;line-height:38px;"
                        >建筑密度</span
                      >
                      <el-form-item class="canton_Regions">
                        <el-select
                        ...
                        >
                          <el-option
                            v-for="(item,
                            index) in buildingDensitySymbolSelect2"
                            :key="index"
                            :label="item.label"
                            :value="item.value"
                          ></el-option>
                      ...
                      <el-form-item
                        class="canton_Regions"
                        prop="buildingDensity2"
                      >
                        <el-input
                          v-model.number="ruleForm.buildingDensity2"
                          placeholder="建筑密度上限"
                          style="width:140px;"
                        ></el-input>
                      </el-form-item>
              ...
              <div class="operfirst">
                <span class="button_bg" @click="submitForm('ruleForm','0')"
                  >下一步</span
                >
              </div>
            </div>
            ...
            <div class="thirdstep AttachmentInfoList_warp" style="background:#fff;"
              v-if="active === 2" align-center
             >
              <!-- 土地附件清单 -->
              <div
                class="EntrustTra_main"
                style="margin:0 auto;"
                v-if="Enclosure"
              >
                <EPF-switchTitle
                ...
                >
                  <div class="EntrustTra_main_cont" style="padding-bottom:0px;">
                    ...
                    <span style="color: #aaa;"
                      >提示：权属人性质为个人时，权属人证件上传身份证；性质为企业时，权属人证件上传营业执照。</span
                    >
                  </div>
                </EPF-switchTitle>
                ...
                >
                  <div class="EntrustTra_main_cont">
                    ...
                    <span
                      ...
                      >上一步</span
                    >
                    <span class="search_input fl" @click="submitLand()"
                      >提交</span
                    >
                    <span
                      class="search_input submit_input fl"
                      @click="submitLand('save')"
                      >保存</span
                    >
                  </div>
                </EPF-switchTitle>
...
export default {
  name: "entrustedTradeDetailsAmend",
  ...
  data() {
    ...
    return {
      ...
      rules: {
        ...
        contactAddressAAA: [{ required: true, message: "联系人/代理人姓名" },
  ...
  methods: {
    ...
    provinceSelect(dic, cantonCode, event) {
      ...
      this.$get(
        // `/epf-trade/dictionaries/getDictsByCodeOrParentId?code=administrative_regions&parentId=${pId}`,
    ...
    idCardSelect(dic, identificationType, event) {
      this.transTrustInfo.identificationType = this.$refs[
        identificationType
      ][0].$attrs.value;
    },
    // 权属人性质选择
    ownerShipSelect(dic, ownerShipNature, event) {
      this.transTrustInfo.ownerShipNature = this.$refs[
        ownerShipNature
      ][0].$attrs.value;
    },
    ...
    photoHandleRemove(file, fileList) {
      ...
      console.log(id);
      let para = { id: id};
      let url = "/epf-document/document/deleteById";
    ...
    handleRemove(file, fileList) {
      ...
      this.$post(url, para).then(res => {
        if (res.state == "SUCCESS") {
          this.$message.warning(res.msg);
          for (let i = 0; i < this.videoUrlId.length; i++) {
            if (this.videoUrlId[i] == file.response.data.data[0].id) {
              console.log(11111111111);
              this.videoUrlId.splice(i, 1);
            }
          }
          this.ruleForm.fileList = fileList;
          console.log(file, fileList, this.videoUrlId);
        }
      });
    },
