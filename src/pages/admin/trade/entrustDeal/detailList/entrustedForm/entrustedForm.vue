        ...
        <div class="publish_main">
          ...
          >
            <div class="firststep" v-if="active===0" align-center>
                  ...
                  <ul class="publish_mainUl">
                      ...
                      <div style="display: flex;flex-direction: row;">
                        <el-form-item label="所属行政区：" prop="cantonProvince">
                          <el-select
                            ...
                            @change="provinceSelect(dictionary.administrative_regions,transGoods.cantonProvinceName,$event)"
                            style="width:90px"
                          >
                            <el-option
                        ...
                        <el-form-item prop="cantonCity" class="canton_Regions">
                          <el-select
                            ...
                            @change="citySelect(dictionary.cantonCity,transGoods.cantonCityName,$event)"
                            style="width:90px"
                          >
                            <el-option
                        ...
                        <el-form-item prop="cantonArea" class="canton_Regions">
                          <el-select
                            ...
                            @change="areaSelect(dictionary.cantonAreaName,transGoods.cantonAreaName,$event)"
                            style="width:90px"
                          >
                            <el-option
                    ...
                    <li>
                      <el-form-item label="使用权类型：" prop="useType">
                        <el-radio-group v-model="transGoods.useType" @change="useTypeSelect">
                          <el-radio
                            v-for="(item,index) in dictionary.use_type"
                            :label="item.dictKey"
                            :key="index"
                          >{{item.zhCn}}</el-radio>
                        </el-radio-group>
                    ...
                    <li>
                      <el-form-item label="土地流转方式：" prop="circulation">
                        <el-select
                          ...
                          @change="circulationSelect(dictionary.flow_mode,transGoods.circulationName,$event)"
                        >
                          <el-option
                      ...
                      <div style="display: flex;flex-direction: row;">
                        <el-form-item label="土地用途：" prop="firstClassUse" style="width:426px;">
                          <el-select
                            ...
                            @change="firstClassUseSelect(dictionary,transGoods.firstClassUseName,$event)"
                          >
                            <el-option
                        ...
                        <el-form-item prop="secondClassUse" class="canton_Regions">
                          <el-select
                            ...
                            @change="secondClassUseSelect(dictionary,transGoods.secondClassUseName,$event)"
                          >
                            <el-option
                    ...
                    <li>
                      <el-form-item label="不动产单元号：" prop="unitNum">
                        <el-input v-model="transGoods.unitNum" placeholder="请输入" style="width:60%;"></el-input>
                      </el-form-item>
                    </li>
                    <li>
                      <el-form-item label="是否连同地上建筑物、其他附着物：" prop="isAdjunct">
                    ...
                    <li>
                      <el-form-item
                        ...
                        ref="decisionNum"
                        :label="transGoods.useType=='transfer2'?'划拨决定书号：':'建设用地使用权出让合同号：'"
                        prop="decisionNum"
                      >
                        <el-input
                          v-if="transGoods.useType == 'transfer2'"
                          v-model="transGoods.decisionNum"
                          placeholder="请输入划拨决定书号"
                          style="width:60%;"
                        ></el-input>
                        <el-input
                          v-if="transGoods.useType == 'tosell'"
                          v-model="transGoods.decisionNum"
                    ...
                    <!-- <li>
                      <el-form-item
                        ...
                        prop="isDevelope"
                      >
                        <el-radio-group v-model="transGoods.isDevelope">
                    ...
                    <li>
                      <el-form-item
                          ...
                          prop="isPercent"
                        >
                          <el-radio-group v-model="transGoods.isPercent">
                            <el-radio :label="0">是</el-radio>
                            <el-radio :label="1">否</el-radio>
                          </el-radio-group>
                        </el-form-item>
                    ...
                    <!-- <div > -->
                      ...
                      <li v-if="transGoods.isAdjunct=='0'">
                        <el-form-item label="建筑结构：" prop="buildType">
                          <el-select
                            v-model="transGoods.buildingStructureName"
                            placeholder="请选择"
                            @change="buildingTypeSelect(dictionary.building_structure,transGoods.buildingStructureName,$event)"
                           >
                            <el-option
                       ...
                       >
                        ...
                        <el-form-item class="canton_Regions">
                          <el-select
                            ...
                            placeholder="请选择符号"
                            style="width:157px;"
                            @change="change($event,transGoods.greenSpaceRateSymbol1,'greenSpaceRateSymbol1')"
                          >
                            <el-option
                        ...
                        <el-form-item class="canton_Regions">
                          <el-select
                            v-model="transGoods.greenSpaceRateSymbol2"
                            placeholder="请选择符号"
                            style="width:157px;"
                            @change="change($event,transGoods.greenSpaceRateSymbol2,'greenSpaceRateSymbol2')"
                          >
                            <el-option
                        ...
                        <el-form-item class="canton_Regions" prop="greenSpaceRate2">
                          <el-input
                            v-model="transGoods.greenSpaceRate2"
                            placeholder="绿地率上限"
                            style="width:140px;"
                          ></el-input>
                        </el-form-item>
                      ...
                      <li
                       ...
                       >
                        <el-form-item label="建筑密度%：" style="width:395px;" prop="buildingDensity">
                          <el-input
                            v-model="transGoods.buildingDensity"
                            placeholder="建筑密度下限"
                            style="width:140px;"
                          ></el-input>
                        </el-form-item>
                        <el-form-item class="canton_Regions">
                          <el-select
                            v-model="transGoods.buildingDensitySymbol1"
                            placeholder="请选择符号"
                            style="width:157px;"
                            @change="change($event,transGoods.buildingDensitySymbol1,'buildingDensitySymbol1')"
                          >
                            <el-option
                        ...
                        <el-form-item class="canton_Regions">
                          <el-select
                            v-model="transGoods.buildingDensitySymbol2"
                            placeholder="请选择符号"
                            style="width:157px;"
                            @change="change($event,transGoods.buildingDensitySymbol2,'buildingDensitySymbol2')"
                          >
                            <el-option
                        ...
                        <el-form-item class="canton_Regions" prop="buildingDensity2">
                          <el-input
                            v-model="transGoods.buildingDensity2"
                            placeholder="建筑密度上限"
                            style="width:140px;"
                          ></el-input>
                        </el-form-item>
                      ...
                      <li
                       ...
                       >
                        ...
                        <el-form-item class="canton_Regions">
                          <el-select
                            v-model="transGoods.plotRatioSymbol1"
                            placeholder="请选择符号"
                            style="width:157px;"
                            @change="change($event,transGoods.plotRatioSymbol1,'plotRatioSymbol1')"
                          >
                            <el-option
                        ...
                        <el-form-item class="canton_Regions">
                          <el-select
                            v-model="transGoods.plotRatioSymbol2"
                            placeholder="请选择符号"
                            style="width:157px;"
                            @change="change($event,transGoods.plotRatioSymbol2,'plotRatioSymbol2')"
                          >
                            <el-option
                    ...
                    <li>
                      <el-form-item label="土地视频：" prop="landVideo">
                        <div style="position:relative;" class="el_videoBox">
                          <div class="videoList">
                            <div
                              v-for="(item,index) in transGoods.fileListVideo"
                              :key="index"
                              class="videoBox"
                            >
                              <video
                          ...
                          <el-upload
                            ...
                            :on-preview="handlePictureCardPreview"
                            :on-remove="file_List_Remove_video"
              ...
              <EPF-switchTitle titles_h="委托机构" :switchData="true">
                <div class="publish_main_cont">
                  <ul class="publish_mainUl">
                    ...
                    <li>
                      <el-form-item label="交易中心：" prop="trustOrgId">
                        <el-select
                          v-model="transGoods.trustOrgId"
              ...
              <div class="operfirst">
                <span class="button_bg" @click="submitForm('transGoods')">下一步</span>
              </div>
            </div>
            ...
            <div class="Secondstep" v-if="active===1" align-center>
                  ...
                  <ul class="publish_mainUl">
                    ...
                    <li>
                      <el-form-item label="权属人性质：" prop="ownerShipNature">
                        <el-select
                          v-model="transGoods.ownerShipNature"
                          placeholder="请选择"
                    ...
                    <li>
                      <el-form-item label="证件种类：" prop="identificationType">
                        ...
                        <el-select
                          v-model="transGoods.identificationType"
                          placeholder="请选择"
                          :disabled="idFlag"
                        >
                          <el-option
                    ...
                    <li>
                      <el-form-item label="联系人/代理人联系地址：" prop="contactAddress"  ref="AddressForm">
                        <el-input
              ...
              <div class="operfirst" style="margin-left:0;margin-top:20px;">
                ...
                <span class="button_bg" @click="next('transGoods')">下一步</span>
              </div>
            </div>
                ...
                <EPF-switchTitle titles_h="委托附件清单" :shutOff="false" background="#fff">
                  <div class="EntrustTra_main_cont">
                    ...
                    <span
                      ...
                      @click="prev"
                    >上一步</span>
                    <span class="search_input fl" @click="submitLand()">提交</span>
                    <span class="search_input submit_input fl" @click="submitLand('save',disabledType)">保存</span>
                  </div>
                </EPF-switchTitle>
              </div>
            </div>
...
import qs from "qs";
import TMap from "@/components/tianditu/taggingMap";
import { mapActions, mapState } from "vuex";
import Bus from "@/utils/bus";
import imgBaseUrl from "@/utils/config";
export default {
  name: "entrustedTradeDetailsAddStep",
  components: { TMap },
  ...
  data() {
    ...
    const numberDator = (rule, value, callback) => {
      if (this.transGoods.circulationName == "出租") {
        if (value < 0 || value > 20) {
    ...
    const greenSpaceRateVa = (rule, value, callback) => {
      ...
      if (
        this.transGoods.greenSpaceRate == "" ||
        this.transGoods.greenSpaceRate == null ||
        this.transGoods.greenSpaceRate2 == "" ||
        this.transGoods.greenSpaceRate2 == null
      ) {
        callback();
      } else {
        if (Number(this.transGoods.greenSpaceRate) > Number(this.transGoods.greenSpaceRate2)) {
    ...
    const buildingDensityVa = (rule, value, callback) => {
      if (
        this.transGoods.buildingDensity == "" ||
        this.transGoods.buildingDensity == null ||
        this.transGoods.buildingDensity2 == "" ||
        this.transGoods.buildingDensity2 == null
      ) {
        callback();
      } else {
        if (
          Number(this.transGoods.buildingDensity) > Number(this.transGoods.buildingDensity2)
        ) {
          callback(new Error("最大值不能小于最小值!"));
        } else {
          callback();
    ...
    const plotRatioVa = (rule, value, callback) => {
      if (
        this.transGoods.plotRatio == "" ||
        this.transGoods.plotRatio == null ||
        this.transGoods.plotRatio2 == "" ||
        this.transGoods.plotRatio2 == null
      ) {
        callback();
      } else {
    ...
    return {
      ...
      rules: {
        trustOrgId: [
          { required: true, message: "请选择地块所属行政区的交易中心" }
        ],
  ...
  created() {
    ...
    setInterval(function() {
      if (_this.active == 1) {
        //获取地块的信息
        let transGoodsJson = _this.transGoods;
        //赋值地区字符
        let areaCode = "";
        //根据条件拼接
  ...
  methods: {
    ...
    getTransGood() {
      this.$get("/epf-trade/admin/transgoods/getTransGoods", {
        ...
        if (this.$route.query.procInsId&&this.$route.query.procInsId!='null') {
          var jsonVars = "{'test':'test'}";
          this.$post("/epf-activiti/act/task/histoicFlow", {
        ...
        if (res.tSell.pId) {
          this.$get("/epf-document/document/getOneGroupFilsById", {
            ...
            this.transGoods.pId = filesData[0].pId;
            filesData.forEach((item, index) => {
              if(item.extName=='mp4'){
                this.transGoods["fileListVideo"].push({
                  url: this.baseUrl + item.id,
                  status: "success",
                  name: item.name
                });
                this.videoUrlId.push(item.id);
              }
              if (
                item.extName == "png" ||
                item.extName == "PNG" ||
                ...
                this.transGoods["fileList"].push({
                  url: this.baseUrl + item.id,
                  status: "success",
                  name: item.name
                });
                this.imgUrlId.push(item.id);
              }
            })
            this.transGoods["id"] = this.$route.query.id;
          });
        }
        let _this = this;
        //获取地块的信息
    ...
    getOrg(id) {
      this.$get(`/epf-admin/admin/org/getOrg?id=` + id, {}).then(res => {
        this.transGoods.trustOrgIdName = res.orgName;
      });
    },
    createId() {
    ...
    buildingTypeSelect(dic, entrustAgency, event) {
      this.transGoods.buildingStructure = this.$refs[entrustAgency][0].$attrs.dictKey;
    },
    ...
    idCardSelect(dic, identificationType, event) {
      this.transGoods.identificationType = this.$refs[
        identificationType
      ][0].$attrs.dictKey;
    },
    // 权属人性质选择
    ownerShipSelect(dic, ownerShipNature, event) {
      this.transGoods.ownerShipNature = this.$refs[
        ownerShipNature
      ][0].$attrs.dictKey;
    },
    ...
    orgselect() {
      ...
      this.$get(`/epf-admin/admin/org/getOrgsByareas`, {
    ...
    submitLandEdit: function(type) {
      debugger;
      if (this.isLoading) {
        return;
      }
      for (let i = 0; i < this.orgs.length; i++) {
        if (this.orgs[i].id == this.transGoods.trustOrgId) {
          this.transGoods["trustOrgName"] = this.orgs[i].orgName;
        }
      }
      //警用按钮
      this.isLoading = true;
      ...
      for (let item in this.transGoods) {
        if (item != "id") {
          this.transGoods[item] = this.transGoods[item];
        }
      }

      for (let item2 in this.transTrustInfo) {
        if (item2 != "id") {
          this.transTrustInfo[item2] = this.transGoods[item2];
        }
      }
      ...
      if ("save" == type) {
        this.transTrustInfo["delegationStatus"] = "draft3";
      } else {
        this.transTrustInfo["delegationStatus"] = "accepting";
      }

      this.transGoods["fileTemplateId"] = this.fileTemplateId;

      this.transGoods["isReapply"] = this.$route.query.reapply;
      let params = {
      ...
      this.$useAppend("/epf-trade/admin/transgoods/editTransGoods", {
    ...
    submitLand: function(type) {
      if(this.disabledType==1){
        this.submitLandEdit(type)
      }else{
        this.submitLandAdd(type)
      }
    },
    ///////////////////////////////////
    // 提交受理
    ...
    videoUploadFile(files) {
      if (this.MPID) {
        this.transGoods.pId = this.MPID;
        // alert("即将要使用的pId:"+this.transGoods.pId);
      }
    ...
    file_List_Remove_video(file, fileListVideo) {
      ///////////////////////////////////////////////////////
      //移除土地图片
      let that = this;
      let self = this;
      if (self.videoUrlId.length == 0) {
        for (let j = 0; j < self.transGoods.fileListVideo.length; j++) {
          let item = self.transGoods.fileListVideo[j];
          let name = item.name;
          // JPG , PNG , GIF
          //1、获取文件名的后三位，看看是否是图片文件
          let type = name.substring(name.length - 3, name.length);
          type = type.toLocaleLowerCase();
          //2、获取文件的ID，储存到videoUrlId中去
          let url = item.url;
          let id = url.substring(url.length - 36, url.length);
          if (type == "jpg" || type == "png" || type == "gif") {
      ...
      this.$post(url, {}).then(res => {
        if (res.state == "SUCCESS") {
          this.transGoods.fileListVideo = fileListVideo;
          this.videoUrlId.forEach((e,i) => {
            if (e == id) {
              this.videoUrlId.splice(i, 1);
            }
          });
        }
      })
    ...
    videoUploadSuccess(res, file, fileList) {
      ...
      console.log("=======fileList========",fileList,this.videoUrlId)
      this.transGoods.fileListVideo = fileList;
      for (let i = 0; i < this.transGoods.fileListVideo.length; i++) {
        if (this.videoUrlId[i] === undefined) {
          break;
        }
        this.transGoods.fileListVideo[i].url = this.baseUrl + this.videoUrlId[i];
      }
    },
    //////////////////////////////
    next(val) {
      console.log(val)
        this.$refs[val].validate(valid => {
          ...
          if (valid) {
            ...
            document.querySelector("#entrustedTradeDetailsAddStep").scrollIntoView(true);
          }
        });
    ...
    ownerShipNatureSelect() {
      if (
        this.transGoods.ownerShipNature != "" &&
        this.transGoods.ownerShipNature != null
      ) {
        this.idFlag = true;
...
.el_videoBox .el-upload-list--picture-card .el-upload-list__item-actions .el-upload-list__item-preview{
  display:none;
}
