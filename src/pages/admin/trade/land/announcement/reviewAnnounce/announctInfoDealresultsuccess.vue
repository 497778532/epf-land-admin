      ...
      <div class="publish_main">
        ...
        <div class="publish_main_cont">
          ...
          <el-tabs style="margin-top:35px;">
            ...
            <el-table-column prop="taskName" label="环节名称" align="center"></el-table-column>
            ...
            <el-table-column prop="endDate" label="审核时间" align="center"></el-table-column>
...
export default {
  ...
  data() {
    return {
      ...
      AuditrecordData:[
        // {no:'01',auditor:'审核人',identity:'县长',status:'通过',statusKey:1,time:'2018-5-3 10:34:24',opinion:'查看详情'},
        // {no:'01',auditor:'审核人',identity:'县长',status:'通过',statusKey:1,time:'2018-5-3 10:34:24',opinion:'查看详情'},
        // {no:'01',auditor:'审核人',identity:'县长',status:'通过',statusKey:1,time:'2018-5-3 10:34:24',opinion:'查看详情'},
        // {no:'01',auditor:'审核人',identity:'县长',status:'通过',statusKey:1,time:'2018-5-3 10:34:24',opinion:'查看详情'},
      ],
  ...
  methods:{
    init(id){
      ...
      this.$post('/epf-activiti/act/task/histoicFlow',{procInsId:id,jsonVars:jsonVars}).then(res => {
        //查询意见
        if(res.code != '0'){
          //失败
