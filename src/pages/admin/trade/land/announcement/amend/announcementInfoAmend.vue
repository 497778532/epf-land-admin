        ...
        methods: {
          onKeyUp(e, editor,flag){
            ...
            getItemData() {
                ...
                this.$get("/epf-trade/admin/transnotice/getTransNotice", parmas).then(
                    res => {
                      debugger
            ...
            saveNotice(type) {
                ...
                this.$useAppend(url, {
                    ...
                    if (res.code == 0) {
                        ...
                        if (that.modelTye == 1) {
                            //重新发布进来的
                            that.$get("/epf-trade/admin/transnotice/setNoticeRevoke", {id: id}).then(res2 => {
                                if (res2.code != 0) {
                            ...
                            //重新提交进来的
                            that.$get("/epf-trade/admin/transnotice/setResubmitNotice", {id: id}).then(res2 => {
                                if (res2.code != 0) {
                                    that.$message.error(res2.msg);
                                    return
                                }
