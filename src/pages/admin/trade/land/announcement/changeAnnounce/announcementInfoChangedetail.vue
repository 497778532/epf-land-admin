                 ...
                 <li>
                    <el-form-item label="公告内容：" style="width:170%;" required>
                      <div style="margin:0; width: 100%;">
                        <editor class="editor" v-model="info" v-html="ruleForm.content" :info="info" @onKeyUp="onKeyUp">{{ruleForm.content}}</editor>
                      </div>
                    </el-form-item>
                    <el-form-item>
                       <div style="margin:0px;width:max-content" v-show="!ruleForm.content">提示：您已输入{{infoLength?infoLength:0}}个字，还可输入{{2000-infoLength}}个字。</div>
                    </el-form-item>
                  </li>
                </ul>
              </div>
              ...
              <div class="publish_main_cont">
                <div class="publish_main_cont_table">
                  ...
                  >
                    ...
                    <el-table-column prop="targetNo" label="标的编号" align="center">
        ...
        created() {
            ...
            this.$get("/epf-trade/admin/transnotice/getTransNotice", {id: this.$route.query.id}).then(res => {
                if (res.code == "0") {
                    ...
                    this.$get(
                        `/epf-trade/admin/transtarget/getTransTargetById?targetId=${res.map.map.targetVos[0].id}`
                    ).then(res => {
                        let _this = this;
                        //获取地块的信息
                        ...
                        //设置附件ID
                        _this.belong = _this.ruleForm.enclosureId
                    });
                    ...
                    if(this.ruleForm.noticeId){
                        ...
                        for (let i = 0; i < this.landmarkInfo.length; i++) {
                            ...
                            this.$get(
                                `/epf-trade/admin/transtarget/getTransTargetTime`,
