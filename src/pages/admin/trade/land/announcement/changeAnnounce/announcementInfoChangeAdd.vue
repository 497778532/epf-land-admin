...
<script>
    ...
    export default {
        name: "announcementInfoChangeAdd",
        data() {
        ...
        created() {
            ...
            if(this.$route.query.resubmitNotice){   //重新提交
              this.modelTye = "2";
            }else if(this.$route.query.edit){
              this.modelTye = "1"; // 修改变更公告
            }
            ...
            if(this.$route.query.edit){
              ...
              //设置附件ID的存储字段
              this.ruleForm.enclosureId = this.$route.query.id;
            ...
            this.$get("/epf-trade/admin/transnotice/getTransNotice", {id: this.$route.query.id}).then(res => {
                if (res.code == "0") {
                  if(this.$route.query.edit){
                    //如果是修改进来
                    this.ruleForm = res.map.map.transNotice;
                    //重新设置公告信息的值
                    this.info = this.ruleForm.content
                    // --公告编号：
                    ...
                    if(this.$route.query.resubmitNotice){   //重新提交
                      this.ruleForm.noticeId = res.map.map.transNotice.noticeId;
                    }else{
                      this.ruleForm.noticeId = this.$route.query.id;
                    }
                    // --公告标题：
