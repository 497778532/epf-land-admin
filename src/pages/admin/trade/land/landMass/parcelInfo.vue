    ...
    <div class="switchHeight_box">
      <el-form ref="filterData" :model="filterData">
        ...
        <el-row>
          ...
          <el-col :span="12">
            <div style="width:155px;float:left;margin-right:9px;">
              <el-select
                ...
                size="small"
                placeholder="所属省"
                @change="provinceSelect(dictionaryCode.administrative_regions,filterData.cantonProvinceName,$event)"
              >
                <el-option
                  v-for="(item,index) in dictionaryCode.administrative_regions"
                  :ref="item.regionName"
                  :id="item.id"
            ...
            <div style="width:155px;float:left;margin-right:9px;">
              <el-select
                ...
                size="small"
                placeholder="所属市"
                @change="citySelect(dictionaryCode.cantonCity,filterData.cantonCityName,$event)"
              >
                <el-option
            ...
            <div style="width:155px;float:left;">
              <el-select
                ...
                size="small"
                placeholder="所属区/县"
                @change="areaSelect(dictionaryCode.cantonAreaName,filterData.cantonAreaName,$event)"
              >
                <el-option
          ...
          <el-col :span="2">
            <div
              style="backgroundColor:#fff;color:#606266;border:solid 1px #d3d4d6;margin-left:25px;"
              class="button_bg"
              @click="resetFilter()"
            >重置</div>
          </el-col>
      ...
      <el-tab-pane label="未绑定" name="0">
        <div>
          ...
          >
            ...
            <el-table-column label="地块编号" width="160">
              <template slot-scope="scope">
                <span @click="viewDeatil(scope.row)" type="text" size="small">{{scope.row.goodsNo}}</span>
              </template>
            </el-table-column>
            ...
            <el-table-column prop="recorderName" label="经办人" width="120"></el-table-column>
            <el-table-column prop="submissionTime" label="申请时间" width="200"></el-table-column>
...
export default {
  ...
  methods: {
    ...
    viewDeatil(item) {
      let title = "地块详情";
      let routerPath = "/parcelInfoDetail";
      let tabObj = { title, routerPath };
      //将当前点击的选项添加到vuex中
      this.setTabsList(tabObj);
      console.log("这是ID：---" + item.id);
      this.$router.push({ path: "/parcelInfoDetail", query: { id: item.id } });
    },
