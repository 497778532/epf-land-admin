                ...
                <ul class="publish_mainUl">
                  <li style="width:100%;">
                    <el-form-item label="竞买资格条件：">
                      <el-input type="textarea" maxlength="200" minlength="0" show-word-limit autosize v-model="ruleForm.biddingterm" placeholder="竞买人需具有一级建造师资格，注册资金达到2亿。。。" style="width:600px;height:120px;"></el-input>
                    </el-form-item>
