            ...
            <div class="publish_main_cont">
              <div class="publish_main_cont_table">
                ...
                >
                  ...
                  <!-- @name: 修改bug3509
                  @description: 点击一个标的，进入后点击绑定的地块编号，没有连接到地块详情​
                  @author: gaojie
                  @chageTime:2020-3-23 -->
                  <el-table-column prop="goodsNo" label="地块编号" width="180" align="center">
    ...
    getItemData() {
      ...
      this.$get(
        ...
        console.log('请求参数附件模板code：',this.annexId,'对象ID：',this.returnNoticeId);
          ...
          let _this = this;
          //获取地块的信息
          let transGoodsJson = this.mydata.transGoods[0];
          //赋值地区字符
          let areaCode = '';
          //根据条件拼接
