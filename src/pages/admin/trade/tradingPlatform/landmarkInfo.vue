    ...
    <div class="filter_wrap">
      ...
      <el-tabs style="margin-top:35px;">
        ...
        >
          ...
          <el-table-column prop="statusName" label="地块状态" width="180">
            <template slot-scope="scope">
              <!-- <span :class="(scope.row.Status!==7&&scope.row.Status!==8)?'success':''"></span>
              <span :class="(scope.row.Status===7)?'error':''"></span>
              <span :class="(scope.row.Status===8)?'default':''"></span>-->
              <span v-if="scope.row.statusName==1">受理中（录件）</span>
              <span v-else-if="scope.row.statusName==2">审核中</span>
              <span v-else-if="scope.row.statusName==3">已审核</span>
              <span v-else-if="scope.row.statusName==4">已公告</span>
              <span v-else-if="scope.row.statusName==5">交易中</span>
              <span v-else-if="scope.row.statusName==6">成交待审核</span>
              <span v-else-if="scope.row.statusName==7">未成交（已流拍）</span>
              <span v-else-if="scope.row.statusName==8">已成交</span>
