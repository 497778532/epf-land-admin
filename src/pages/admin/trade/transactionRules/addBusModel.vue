<template>
  <div class="page-body">
    ...
    <div class="addRule" style="margin-top:25px;">
      ...
      <el-button type="primary" :disabled="!modify" @click="addModleFun()">
        新增
      </el-button>
    </div>
    <el-table
  ...
  export default {
    ...
    mounted () {
      ...
      if (this.$route.query.id) {
        ...
        this.$get('/epf-tradeengine/admin/transbusinessmodel/getTransBusinessModel', {id: this.$route.query.id}).then(res => {
          // res 是返回结果
          if (res.code != 0) {
    ...
    methods: {
      ...
      pendingParamsList () {
        //调用接口查询竞买申请步骤列表接口数据
        this.$get('/epf-tradeengine/admin/translicensestep/getTransLicenseStepJson', {page: 1, rows: 10000}).then(res => {
          // res 是返回结果
          if (res.code != 0) {
            this.$message.error(res.msg)
            return
      ...
      putTransaction () {
        ...
        if (this.busParams.id) {
          message = '修改成功'
          url = '/epf-tradeengine/admin/transbusinessmodel/editTransBusinessModel'
          Params = {
            'transAllJson': {
              'businessModelJson': {
          ...
          message = '添加成功'
          url = '/epf-tradeengine/admin/transbusinessmodel/addTransBusinessModel'
          Params = {
            'transAllJson': {
              'businessModelJson': {
                'goodsType': this.busParams.goodsType,
