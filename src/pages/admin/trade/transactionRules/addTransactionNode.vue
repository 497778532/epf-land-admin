<template>
  <div class="page-body">
    ...
    <div class="addRule" style="margin-top:25px;">
      ...
      <el-button type="primary" :disabled="!modify" @click="addNode()">
        新增
      </el-button>
    </div>
    <el-table
  ...
  export default {
    ...
    mounted () {
      ...
      if (this.$route.query.id) {
        ...
        this.$get('/epf-tradeengine/transnodetemplate/getTransNodeTemplate', {id: this.$route.query.id}).then(res => {
          // res 是返回结果
          if (res.code != 0) {
    ...
    methods: {
      ...
      queryDic (code) {
        let url = '/epf-supply/dictionaries/getDictEbyDictGroup/' + code
        //查询字典值
