<template>
  <div style="padding:30px 0 0 20px">
    <el-row class="mainAccounts">
      <el-form ref="filterData" :model="filterData">
        ...
        <el-col :span="1" :offset="1" style="margin-top:20px">
          <div class="button_bg" @click="getBidRefund({realName:filterData.Bidder,targetId:targetId})">查询</div>
        </el-col>
    ...
    <el-table ref="multipleTable" :data="tableData" tooltip-effect="dark" style="width: 100%">
      ...
      <el-table-column prop="name" label="竞买人" width="100" align="left"></el-table-column>
      <el-table-column prop="accountNo" label="子账户" width="145" align="left"></el-table-column>
      <el-table-column  label="金额" width="200" align="left">
  ...
  methods: {
    ...
    btnClick: async function(val, type) {
      ...
      const res = await this.$post(
        "/epf-trade/finance/switchToBackMoney",
        paras
      );
      if (res.code == "0") {
    ...
    getBidRefund: async function(params) {
      const res = await this.$get(
        "/epf-trade/finance/swithPayBackList",
        params
      );
      if (res.code == "0") {
