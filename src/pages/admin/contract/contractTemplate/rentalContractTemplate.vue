			...
			<div class="signatureDetails_cont signlist0 signlist1">
				...
				<div class="signNum">
					<div class="signNumCon">
						<p v-if="mydata.contractStatus!=='contract_status-008' && mydata.contractStatus!=='contract_status-005'">合同编号：{{this.mydata.code}}</p>
						<p v-if="mydata.contractStatus=='contract_status-008' || mydata.contractStatus=='contract_status-005'">合同统一编码：{{mydata.recordNo}}</p>
					</div>
				</div>
				<div class="signtitle">
				...
				<div class="signlist signlist4">
					...
					<!-- <p>2.本合同出租不动产租金为人民币 (大写）{{this.mydata.rent1}} /月(小写）{{this.mydata.rent/10000}}万/月,总租金为人民币(大写） {{this.mydata.total}} (小写）{{(this.mydata.rent*this.mydata.term)/10000}}万元。</p> -->
