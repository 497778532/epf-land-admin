<template>
  <div class="page-body" id="libraryManage">
    <div
      class="filter_wrap"
    ...
    >
      ...
      <el-container style="height:auto; margin-top:10px">
        ...
        <el-aside width="260px">
            ...
            >文档分类<el-button class="button_bg" @click="addLevelOne" style="float:right;height:30px;margin-top:5px;">添加顶级</el-button></el-header>
            <el-main
        ...
        <el-main style="margin-left:15px;">
          <el-tabs>
            <el-header
              ...
              class="m_title"
            >
              <span style="font-weight:bold">文档分类</span>
              <div class="tableHead">
                ...
                <span>
                  ...
                  <span  class="button_bg" @click="markdown">markdown</span>
                  <span  class="button_export" @click="exportDocument">导出exel</span>
                </span>
              </div>
            </el-header>
  ...
  methods: {
      ...
      queryDictList() {
            ...
            that.$post('/epf-admin/admin/dict/getDictDataByCode', {'codes': codes}).then(res => {
              ...
              let data = res.data;
              let doc_sourse=data.doc_sourse;
              let lists=[];
              for (let index = 0; index < doc_sourse.length; index++) {
                lists.push({name:doc_sourse[index]["zhCn"],value:doc_sourse[index]["zhCn"]})
              }
              that.resourcedata = lists;
            });
        },
      ...
      markdown(){
        let that = this;
        let title = '新增markdown'
        let routerPath = '/markdown'
        let tabObj = {title, routerPath}
        that.setTabsList(tabObj)
        that.$router.push({path: routerPath,query:{editor:""}})
      },
      async getDocList(params) {
        console.log("publish",this.publishdata)
