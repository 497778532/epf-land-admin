    ...
    <div id="menuManage">
        <el-container>
            <el-aside width="300px" style="padding-top:10px;padding-left:20px;">
                <el-container>
                <el-header :style="{background:theme_BackgroundColor,color:theme_TextColor}" class="m_title" >菜单</el-header>
            ...
            <el-main style="margin-left:15px;padding-top:10px;padding-right:20px;">
                <el-container>
                <el-header :style="{background:theme_BackgroundColor,color:theme_TextColor}" class="m_title">菜单信息</el-header>
                <div style="height:40px;padding:6px 22px;background:rgb(224, 224, 224);">
                    <el-button size="mini" @click="saveMenu">保存123</el-button>
        ...
        laodmenus(){
            ...
            this.$get('/epf-admin/admin/menu/getAllMenuList').then(res => {
                 ...
                 for(let i = 0;i<res.menus.length;i++){
                     for(let j = 0;j<res.menus[i].length;i++){

                     }
                 }
                console.log('菜单节点返回：',res.menus)
                 this.loading = false
            })
        },
        laodtenentry(){
            this.loading = true
            this.$post('/epf-admin/admin/Tenantry/getOwnTenantryList').then(res => {
                if(res.code!=0){
                    return
                }
