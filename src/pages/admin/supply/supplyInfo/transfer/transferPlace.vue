        ...
        <div class="switchHeight_box" style="padding-top:0">
          ...
          >
            ...
            >
              <template slot-scope="scope">
                <span
                  @click="rowClickHandle(scope.row, 1)"
            ...
            >
              <template slot-scope="scope">
                <span
                  :class="scope.row.publishStatus == 'audit' ? 'default' : ''"
                ></span>
                <span
                  :class="scope.row.publishStatus == 'draft2' ? 'default' : ''"
                ></span>
                <span
                  :class="
                    scope.row.publishStatus == 'audit_failure' ? 'error' : ''
                  "
                ></span>
                <span
                  :class="
                    scope.row.publishStatus == 'published2' ? 'success' : ''
                  "
                ></span>
            ...
            >
              <template slot-scope="scope">
                <!-- <span v-for="(button ,index)  in buttons" :key="index">
                      <el-button
                        v-if="button.resourceId=='transfer_audit'"
                        size="mini"
                        type="success"
                        plain
                      ...
                      >审核</el-button>
                      <el-button
                        v-if="button.resourceId=='transfer_autoaudit'"
                        size="mini"
                        type="primary"
                        plain
        ...
        <div class="switchHeight_box" style="padding-top:0">
          ...
          >
            ...
            >
              <template slot-scope="scope">
                <span
                  @click="rowClickHandle(scope.row, 2)"
                  style="text-align:center;cursor:pointer;color: #4772d5;"
                  >{{ scope.row.publishNo }}</span
                >
              </template>
            ...
            >
              <template slot-scope="scope">
                ...
                <span
                  :class="
                    scope.row.publishStatus == 'down_mytsell' ? 'default' : ''
                  "
                ></span>
                <span
                  :class="
            ...
            >
              <template slot-scope="scope">
                <!-- <span v-for="(button ,index)  in buttons" :key="index">
                  <el-button
                    v-if="button.resourceId=='transfer_viewresult'"
                    size="mini"
                    type="primary"
                    plain
                  ...
                  >查看审核结果</el-button>
                  <el-button
                    v-if="button.resourceId=='transfer_checkout' && scope.row.publishStatus == 'published2'"
                    size="mini"
                    type="danger"
                    plain
...
export default {
  ...
  created() {
    ...
    this.buttons = JSON.parse(localStorage.getItem("transferPlace"));
  ...
  methods: {
    ...
    lowerLand() {
      ...
      this.$post("/epf-supply/admin/tsell/editTSellPublishStatus", {
        ...
        this.$message({ message: "下架完成", type: "success" });
        //刷新页面
        this.reload();
      });
    },
