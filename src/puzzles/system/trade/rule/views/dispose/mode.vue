    ...
    <epf-container title="交易方式">
            ...
            <el-row>
                ...
                <el-col :span="6">
                    <selectInput v-model="processedParams.transType" :groupCode="'trans_type'"
                        :default="processedParams.transType">
                    </selectInput>
                </el-col>
        ...
        <div class="epf_fr_box" :style="{height:boxHeight- 165 +'px'}">
            <div class="epf_toolbar">
                ...
                <div class="oper">
                    <button class="epf_btn epf_btn_bg" @click="choiceNode"> 选择节点</button>
                    <button class="epf_btn epf_btn_bg"  @click="addNode"> 新 增</button>
                </div>
            </div>
            <div class="epf_fr_content contents epf_no_border" :style="{height:boxHeight - 205 +'px'}">
                ...
                <div style="margin-top:30px;">
                    <button class="epf_btn epf_btn_bg" @click="putTransaction"> 确 定</button>
                    <button class="epf_btn epf_btn_def" @click="exitTransaction"> 取 消</button>
                </div>
            </div>
        </div>
        <!-- 选择节点 -->
    ...
    data(){
     ...
     mounted () {
        ...
        if (this.$route.query.id) {
            ...
            this.$get(this.$API.EPF_TRADEENGINE.LOG.GET_TYPE, {id: this.$route.query.id}).then(res => {
            // res 是返回结果
            if (res.code != 0) {
