    ...
    <epf-container title="转入主账户">
            ...
            <el-form ref="filterData" :model="filterData">
                <el-row class="mainAccounts">
                    ...
                    <el-col :span="5" style="text-align:right">
                        <button class="epf_btn epf_btn_bg" @click="getPerShiftToMainAccount({realName:filterData.Bidder,targetId:targetId})"> 查 询</button>
        ...
        <div class="epf_fr_box" :style="{height:boxHeight- 165 +'px'}">
            <div class="epf_toolbar">
                <span class="toolsTitle">履约保证金转入主账户</span>
                <span>标的编号:</span>
                <em>{{targetNo}}</em>
                <span>流转方式:</span>
                <em>{{businessType}}</em>
            ...
            <div class="epf_fr_content contents epf_no_border" :style="{height:boxHeight - 205 +'px'}">
                <el-table
                    ...
                    <el-table-column prop="name" label="委托人" width="140" align="left"></el-table-column>
                    <el-table-column prop="accountNo" label="子账户" width="230" align="left"></el-table-column>
                    <el-table-column prop="amountDesc" label="金额" width="120" align="left">
                    ...
                    <el-table-column prop="isValid" label="是否使用" width="110" align="left"></el-table-column>
    ...
    methods: {
        ...
        overTo: async function(myid) {
            const res = await this.$get(
                this.$API.EPF_TRADE.FINANCE.PER_ACCOUNT,
                {
                targetId: this.$route.query.targetId,
                ids: myid
                }
        ...
        getPerShiftToMainAccount: async function(myparams) {
            const res = await this.$get(
                this.$API.EPF_TRADE.FINANCE.PER_LIST,
                myparams
            );
            if (res.code == "0") {
