            ...
            <el-form ref="filterData" :model="filterData">
                <el-row class="mainAccounts">
                    ...
                    <el-col :span="5" style="text-align:right">
                        <button class="epf_btn epf_btn_bg" @click="getPerRefund({realName:filterData.Bidder,targetId:targetId})"> 查 询</button>
    ...
    methods: {
        ...
        btnClick: async function(val, type) {
            ...
            const res = await this.$post(
                this.$API.EPF_TRADE.FINANCE.PER_MONEY,
                paras
            );
            if (res.code == "0") {
        ...
        getPerRefund: async function(myparams) {
            const res = await this.$get(
                this.$API.EPF_TRADE.FINANCE.PER_BACK,myparams
            );
            if (res.code == "0") {
