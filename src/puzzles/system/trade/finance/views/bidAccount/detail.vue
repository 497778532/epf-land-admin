        ...
        <div class="epf_fr_box" :style="{height:boxHeight- 165 +'px'}">
            ...
            <div class="epf_fr_content contents epf_no_border" :style="{height:boxHeight - 205 +'px'}">
                <el-table ref="multipleTable" :data="mistakeList" style="width: 100%" border :height="boxHeight - 270">
                    ...
                    <el-table-column prop="bidderAccountBankName" label="交款账户开户行" width="190" align="center"></el-table-column>
...
export default {
    ...
    methods: {
        ...
        getItemData(val) {
            ...
            this.$get(this.$API.EPF_TRADE.FINANCE.ARRIVAL_COMPETE,{applyId:id},params).then(res => {
                console.log(res);
