        ...
        <el-tabs v-model="activeTabs" type="border-card" @tab-click="handleClick">
                ...
                <div class="epf_fr_box" :style="{height:boxHeight- 165 +'px'}">
                    ...
                    <div class="epf_fr_content contents epf_no_border" :style="{height:boxHeight - 205 +'px'}">
                        <el-table
                            ...
                            <el-table-column prop="targetNo" label="标的编号" width="140" align="center"></el-table-column>
                            ...
                            <el-table-column prop="okTime" label="是否截止时间前到账" align="center"></el-table-column>
                        </el-table>
                        <!-- 分页控件 -->
            ...
            <el-tab-pane label="错转款" name="processed">
                ...
                <div class="epf_fr_box" :style="{height:boxHeight- 165 +'px'}">
                    ...
                    <div class="epf_fr_content contents epf_no_border" :style="{height:boxHeight - 205 +'px'}">
                        <el-table ref="multipleTable" :data="bidList" style="width: 100%" border :height="boxHeight - 270"> 
                            <el-table-column label="序号" width="90px" align="center">
                            <template slot-scope="scope">{{scope.$index+1}}</template>
                            </el-table-column>
                            <el-table-column prop="targetNo" label="标的编号" width="140" align="center"></el-table-column>
...
export default {
    ...
    methods:{
        getList(params) {
            ...
            this.$get(
                this.$API.EPF_TRADE.FINANCE.ARRIVAL_LIST,
                params
            ).then(res => {
        ...
        handleView(item) {
            let title = "错转款详情";
            let routerPath = '/system/trade/finance/views/bidAccount/detail';
