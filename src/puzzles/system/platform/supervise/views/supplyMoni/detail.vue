        ...
        <el-tab-pane label="地块基本信息">
          <div class="main_content">
            ...
            >
              ...
              <tr height="50px">
                <td>
                  <span class="left_text special_text" v-if="provideData.useTypeName == '划拨'">划拨决定书号：</span>
                  <span class="left_text special_text" v-if="provideData.useTypeName == '出让'">建设用地使用权出让合同号：</span>
