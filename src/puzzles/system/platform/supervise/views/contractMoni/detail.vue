          ...
          <div class="signatureDetails_warp" v-if="myDetail.landTypeName=='出租'">
            ...
            <div class="signatureDetails_list">
              <div class="signatureDetails_cont">
                ...
                <div class="signtitle" ref="signlist0">
                  {{myDetail.contractName}}
                  <div v-if="rules1.contractStatus==='contract_status-003'" class="contractCancel">
                    <span></span>合同撤销审核中
                  </div>
                  <div v-if="rules1.contractStatus==='contract_status-004'" class="contractCancel">
                    <span></span>审核中
                  </div>
                  <div v-if="rules1.contractStatus==='contract_status-005'" class="contractsuccess">
                    <span></span>审核通过
                  </div>
                  <div
                    v-if="rules1.contractStatus==='contract_status-006'"
                    class="contractnosuccess"
                  >
                    <span></span>审核未通过
                  </div>
                  <div
                    v-if="rules1.contractStatus==='contract_status-007'"
                    class="contractnosuccess"
                  >
                    <span></span>审核已撤销
                  </div>
                ...
                <div class="signlist" ref="signlist3">
                  ...
                  <!-- <p>2.本合同出租不动产租金为人民币 {{rules1.rent1}} /月(大写）,总租金为人民币 {{rules1.total}} (大写）。</p> -->
