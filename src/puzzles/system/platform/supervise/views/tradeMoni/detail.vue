  ...
  <div class="page-body" id="dealDetail">
    ...
    <div class="filter_wrap" style="margin-bottom:20px;">
      <div class="switchHeight_box">
        ...
        >
          <el-table-column prop="title" label="公告标题" width="425"></el-table-column>
          <el-table-column prop="noticeNo" label="公告编号" width="420"></el-table-column>
          <el-table-column prop="noticeTypeName" label="公告类型" width="210"></el-table-column>
          ...
          <div class="main_content">
            ...
            >
              ...
              <tr height="50px">
                ...
                <td>
                  <span class="left_text special_text">拟转让总价：</span>{{target.price}}
                </td>
              </tr>
              <tr height="50px">
                <td>
        ...
        <el-tab-pane label="竞价记录" name="buyRecord">
          <div class="main_content">
            ...
            >
              ...
              <el-table-column prop="paymentTime" label="缴纳时间" width="280"></el-table-column>
              <el-table-column prop="paymentPrice" label="缴纳金额" width="405"></el-table-column>
              <el-table-column prop="paymentResult" label="缴纳结果" width="405"></el-table-column>
            </el-table>
            <div class="table_th" style="margin-top:35px;">
        ...
        <el-tab-pane label="竞买结果" name="buyResult">
          <div class="main_content">
            ...
            >
              ...
              <el-table-column prop="noticeNo" label="公告编号" width="280"></el-table-column>
