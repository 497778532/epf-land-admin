    ...
    <epf-container title="项目交易结构分析">
        ...
        <div class="epf_fr_box" :style="{height:boxHeight- 165 +'px'}">
            <el-tabs
                ...
                >
                <el-tab-pane label="转让" name="transfer" style="width:100%;height:100%;" lazy>
                    <div class="toolsTitleBox" style="background-color:#fff;border:0;">
                    </div>
                    <div id="structureTChart" style="width:100%;height:400px;margin-bottom:75px;"></div>
                </el-tab-pane>
                <el-tab-pane label="出租" name="rent" style="width:100%;height:100%;" lazy>
                    <div class="toolsTitleBox" style="background-color:#fff;border:0;">
                    </div>
                    <div id="structureRChart" style="width:100%;height:400px;margin-bottom:75px;"></div>
                </el-tab-pane>
                <el-tab-pane label="抵押" name="mortgage" style="width:100%;height:100%;" lazy>
                    <div class="toolsTitleBox" style="background-color:#fff;border:0;">
                    </div>
                    <div id="structureMChart" style="width:100%;height:400px;margin-bottom:75px;"></div>
                </el-tab-pane>
            </el-tabs>
        </div> 
    </epf-container>
