                ...
                <div class="epf_fr_box" :style="{height:boxHeight- 165 +'px'}"> 
                    <el-tabs
                        ...
                        <el-tab-pane
                            ...
                            <div class="epf_fr_content contents epf_no_border" :style="{height:boxHeight - 255 +'px'}">
                            ...
                            <div class="epf_fr_content contents epf_no_border" :style="{height:boxHeight - 255 +'px'}">
                                <el-table
                                    ...
                                    <template slot-scope="scope">
                                        ...
                                        <span v-if="scope.row.landCharName!='null'">{{scope.row.landCharName}}</span>
                                    </template>
                                    </el-table-column>
                                    ...
                                    <el-table-column prop="statusName" label="交易状态" min-width="150"></el-table-column>
                                    <el-table-column prop="sumCount" label="宗数" min-width="150"></el-table-column>
                                    <el-table-column prop="amount" label="金额（万元）" min-width="150">
                                    <template slot-scope="scope">
                                        <span v-if="scope.row.statusName=='流拍'">-</span>
                                        <span v-else>{{scope.row.amount}}</span>
                                    </template>
                                    </el-table-column>
                                    <el-table-column prop="sumArea" label="面积（万平方米）" min-width="150" fixed="right"></el-table-column>
                                </el-table>
                                <!-- 分页控件 -->
...
export default {
    ...
    created() {
        this.boxHeight = window.innerHeight - 320;
