    ...
    <div class="publishTra_main">
        ...
        <div class="publishTra_main_cont">
            ...
            <div style="display: flex;flex-direction: row;">
              ...
              <el-form-item label="等级：" prop="companyLevel">
                <el-select 
                        style="width:300px;"
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        ...
        creditCode: [
          ...
          { min: 1, max: 18, message: "统一社会信用代码设计为18位" },
          {
            ...
            message: "统一社会信用代码设计为18位，使用阿拉伯数字或英文字母表示."
          }
        ],
        serverType: [
      ...
      //   companyName: [
      //       { required: true, message: "请输入公司名称",},
      //       // { min: 1,max: 30,message: "长度在 3 到 30个字符"},
      ...
      //   businessScope: [
      //     { required: true, message: "请输入经营范围"},
      //     {min: 1,max:4000,message: "长度在 1 到 4000个字符"},
      //     { pattern: /^[\u4E00-\u9FA5a-zA-Z0-9][\u4E00-\u9FA5A-Za-z0-9\、\,\，\_\-\———\【】()（）]+$/,message: '可以输入文字、数字英文及部分标点符号，顿号、逗号、连接号（-）、破折号、括号（）【】.'}
      //     ],
      //   corporation:[
      //       { required: true, message: "请输入法人名称"},
