        ...
        <div class="epf_fr_box" :style="{height:boxHeight - 200 +'px'}">
            <div class="epf_toolbar epf_align_right">
                ...
                <el-upload
                    ...
                    >
                    <el-button size="small" type="primary" id="dr" v-show="false"></el-button>
                </el-upload>
                <button class="epf_btn epf_btn_bg" @click="xlsExport">模板下载</button>
                <button class="epf_btn epf_btn_bg" @click="clickDR" :disabled="disabled">导 入</button>
                <button class="epf_btn epf_btn_def" @click="addForm">添 加</button>
            </div>
            <el-table :data="tableData" border :height="boxHeight - 270"  @row-dblclick="rowClickHandle" style="width: 100%">
                ...
                <el-table-column prop="creditCode" label="统一信用代码" min-width="180" align="left"></el-table-column>
                <el-table-column prop="companyName" label="机构名称" min-width="250" align="left"></el-table-column>
                <el-table-column prop="companyTypeName" label="公司类型" min-width="120" align="left"></el-table-column>
                <el-table-column prop="corporation" label="法人名称" min-width="100" align="left"></el-table-column>
                <el-table-column prop="contactPerson" label="联系人" min-width="80" align="left"></el-table-column>
                <el-table-column prop="phone" label="联系电话" min-width="120" align="left"></el-table-column>
                ...
                <template slot-scope="scope">
                    ...
                    />
                    <div v-else style="width:50px;height:50px;background:#F0F0F0"></div>
                    </span>
                </template>
                </el-table-column>
                <el-table-column prop="companyLevelName" label="等级" min-width="60" align="left"></el-table-column>
                <el-table-column prop="statusName" label="状态" min-width="60" align="left"></el-table-column>
                <el-table-column prop="insertTime" label="录入时间" min-width="160" align="left"></el-table-column>
                <el-table-column fixed="right" label="操作" min-width="160" align="center">
                <template slot-scope="scope">
                    <span class="downInfo" @click="editCompanInfo(scope.row.id)">修改</span>
                    <span
                    class="downInfo"
                    v-if="scope.row.status=='company_status-002'"
                    @click="startOrStop(scope.row.id,'company_status-001', scope.$index)"
                    >启用</span>
                    <span
                    class="downInfo"
                    v-if="scope.row.status=='company_status-001'"
                    @click="startOrStop(scope.row.id,'company_status-002', scope.$index)"
                    >停用</span>
                </template>
                </el-table-column>
            </el-table>
...
export default {
  ...
  methods: {
    ...
    addForm() {
        let title = "添加服务机构";
        let routerPath = '/system/supply/serverOrg/views/serverOrg/addOrg';
