<template>
  ...
  <epf-container title="出租地块信息">
      ...
      <div class="epf_fr_box" :style="{height:boxHeight- 155 +'px'}">
        <el-tab-pane label="待处理" name="pending">
          <div class="toolsTitleBox">
            <span class="toolsTitle">出租地块信息</span>
    ...
    <!-- 弹窗 -->
    <el-dialog title="审核" width="40%" :visible.sync="dialogForm" append-to-body>
      <template>
        <div id="dialog">
...
export default {
  ...
  methods: {
    ...
    //   this.$get("/epf-supply/admin/tsell/getTSellForBack", params).then(res => {
      // this.$get(this.$API.EPF_ADMIN.TSELL.TSELL_FOR_BACK, params).then(res => {
      //   if (res.code != 0) {
