        ...
        <el-row style="margin-left:20px">
          ...
          <el-col :span="12">
            <el-form-item label-width="4em" label="URI" prop="name">
              <el-input v-model="advertData.uri" placeholder="请输入URI" style="width:80%"></el-input>
...
export default {
  ...
  data() {
    return {
      advertData:{'applicationName':'','uri':'','version':'','permissionStatus':''},
      rules: {},
      disabled: false,
  ...
  methods: {
    ...
    saveChangeData (){
      debugger
      let that = this;
      this.$post('/epf-admin/appUri/add', that.advertData).then(res => {
        if (res.code != "0") {
