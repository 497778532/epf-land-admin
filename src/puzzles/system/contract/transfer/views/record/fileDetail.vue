...
export default {
    ...
    methods: {
        ...
        auditResult(contractId, businessId, procDefId, procInsId, taskId) {
            let title = "合同撤销审核详情";
            let routerPath = 
            `/system/contract/transfer/views/record/revoke?contractId=${this.$route.query.contractId}&contractType=${this.$route.query.contractType}&businessId=${businessId}&procDefId=${procDefId}&procInsId=${procInsId}&taskId=${taskId}&auditStateTitle=${title}&ifAudit=${ifAudit}`;
