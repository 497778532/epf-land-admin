            ...
            <el-row :gutter="2">
                ...
                <el-col :span="3">
                    <el-select
                        ...
                        placeholder="全部"
                        @change="statusSelect(dictionary.purchasr_status,filterData.status,$event)"
                        >
                        <el-option
        ...
        <div class="epf_fr_box" :style="{height:boxHeight- 165 +'px'}"> 
            ...
            <div class="epf_fr_content contents epf_no_border" :style="{height:boxHeight - 205 +'px'}">
                <el-table
                    ...
                    <el-table-column prop="noMainCount" label="关联信息" width="120" align="left">
                    <template slot-scope="scope">
                        <span
                        class="titleHover"
                    ...
                    <template slot-scope="scope">
                        <el-button size="mini" type="success" plain @click="viewDetail(scope.row.contractId,scope.row.procInsId,'rental')">查看详情</el-button>
